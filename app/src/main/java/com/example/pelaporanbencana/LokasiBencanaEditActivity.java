...
public class LokasiBencanaEditActivity extends AppCompatActivity implements LokBencanaRecViewAdapter.LokClickListener{
...
//        lokasiBencanas = new ArrayList<>();
        ...
        call.enqueue(new Callback<UrbanVillageResponse>() {
            ...
            public void onResponse(Call<UrbanVillageResponse> call, Response<UrbanVillageResponse> response) {
                ...
                if (urbanVillageResponse != null && urbanVillageResponse.isSuccess()){
                    ...
                    Toast.makeText(LokasiBencanaEditActivity.this, "Gagal dapat data" + accessToken, Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<UrbanVillageResponse> call, Throwable t) {
                Toast.makeText(LokasiBencanaEditActivity.this, "Gagal dapat data (2)", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onClick(View view, LokasiBencana lokasiBencana) {
        ...
        Intent intent = new Intent(this, KejadianEditForms1Activity.class);
